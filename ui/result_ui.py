...
.eyebrow { font-size: 12px; color: #2f855a; font-weight: 800; letter-spacing: 0.08em; }
.h2 { font-size: 28px; font-weight: 900; margin-top: 6px; }
.subtitle { font-size: 14px; color: #718096; margin-top: 6px; }

.stepper { width: 100%; background: #fff; border-radius: 16px; box-shadow: 0 10px 30px rgba(15, 23, 42, 0.08); padding: 14px 16px; display: flex; align-items: center; gap: 10px; margin: 16px 0 18px; }
...
.summary-bar { display: flex; align-items: center; gap: 14px; background: #fff; border-radius: 16px; padding: 12px 18px; box-shadow: 0 10px 30px rgba(15, 23, 42, 0.08); margin-bottom: 18px; flex-wrap: wrap; }
